...
var myAge = 50 * 2 / 2 - 25 + 2

console.log('question 2 answer', myAge)
// Code Here
...
var myString = 'make this uppercase'

myString = myString.toUpperCase()

console.log('question 3 answer', myString)
//Code here
...
var newString = 'MAKE THIS LOWERCASE'

newString = newString.toLowerCase()

console.log('question 4 answer', newString)
//Code Here
...
console.log('question 5 answer', favoriteActivity)
// Code Here
...
console.log('question 6 answer', myFirstName, myFavoriteNum, havingFun)
//Code HERE
...
console.log('question 7 answer', myFirstSum)

//---------------------------------------------------------------------------------------


// QUESTION 8: Express Guess
...
console.log('question 8 answer', myGuess)
...
console.log('question 9 answer', happyNum)
